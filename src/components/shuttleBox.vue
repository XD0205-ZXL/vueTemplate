    ...
    <div class="shuttleBox le_comps_core_css">
        <div class="leftBox">
            <div class="le_form_row_item">
                <le-input labelWidth="80" label="未分配权限:" v-model="searchModel.unabsorbed"></le-input>
                <le-button type="search" value="搜索" @click="changeLeftData"></le-button>
            </div>
            <ul>
        ...
        <div class="rightBox">
            <div class="le_form_row_item">
                <le-input labelWidth="80" label="已分配权限:" v-model="searchModel.assigned"></le-input>
                <le-button type="search" value="搜索" @click="changeRightData"></le-button>
            </div>
            <ul>
